...
import (
	...
	"stash.appscode.dev/mariadb/apis/installer/v1alpha1"
...
func TestStashMariaDBDefaultValues(t *testing.T) {
	diffstring, err := compareStashMariaDBDefaultValues()
	if err != nil {
		t.Error(err)
	}
	if diffstring != "" {
...
func compareStashMariaDBDefaultValues() (string, error) {
	data, err := ioutil.ReadFile("../../../charts/stash-mariadb/values.yaml")
	if err != nil {
		return "", err
	}
	...
	var spec v1alpha1.StashMariaDBSpec
